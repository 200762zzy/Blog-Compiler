...
FILE_SVG = """<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>
</svg>"""

IMAGE_SVG = """<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  <rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>
</svg>"""

HISTORY_SVG = """<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
def get(name: str, size: int = 20, color: str | None = None) -> QIcon:
    ...
    if key not in icons:
        svg_map = {
            ...
            "file": FILE_SVG, "image": IMAGE_SVG, "history": HISTORY_SVG,
        }
